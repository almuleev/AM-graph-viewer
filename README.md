...
<p align="center">
  ...
  &middot;
  <a href="https://github.com/almuleev/am-graph-viewer/releases/latest"><strong>Download latest release</strong></a>
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/almuleev/am-graph-viewer?display_name=tag&sort=semver" alt="Latest release">
  <img src="https://img.shields.io/github/license/almuleev/am-graph-viewer" alt="License">
...
The project includes two front ends built on one shared parsing and analysis core:
  ...
  - `AMGraphViewer-v0.11.5-win-x64.exe` - native desktop viewer for interactive work
...
3. Double-click `Start GUI.bat` or `AMGraphViewer-v0.11.5-win-x64.exe`.
