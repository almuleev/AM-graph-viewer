...
- FRF / АЧХ: `frf_analysis` (численное ядро без GUI, среднее опор до H1,
  ...
  `gui_frf` (встроенный выбор ролей/задания/кэш), `gui_frf_render` (КД,
  ...
  Выбор опор и откликов открывается встроенным в правую панель редактором ролей,
  а не отдельным модальным окном.
